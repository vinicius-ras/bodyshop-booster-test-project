...
using BodyShopBoosterTest.Extensions;
	...
	public class ValidationProblemDetailsFilter : ISchemaFilter
	{
		...
		public void Apply(OpenApiSchema schema, SchemaFilterContext context)
		{
			...
			propErrors.Example = new OpenApiObject {
				[nameof(Estimate.FirstName)] = new OpenApiArray {
					new OpenApiString("This field is required."),
				},
				[nameof(Estimate.CarType)] = new OpenApiArray {
					new OpenApiString("Vehicle type is required."),
					new OpenApiString("Vehicle type must have between 1 and 20 characters."),
				}
			};
		}
	}
